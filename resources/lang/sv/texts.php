...
return array (
  ...
  'user_email_footer' => 'För att anpassa dina e-post notifieringar gå till https://ninja.local/company/notifications',
  ...
  'reset_password_footer' => 'Om du inte begärt en återställning av ditt lösenord så var snäll och maila vår support: dan@omniscience.co.il',
  ...
  'limit_users' => 'Ledsen, men du får skapa max 20 användare',
  ...
  'more_designs_self_host_header' => 'Få ytterliggare 6 fakturalayouter för bara $10',
  ...
  'white_label_text' => 'Köp en white label licens för $20 för att ta bort Invoice Ninja loggan från kundernas sidor.',
